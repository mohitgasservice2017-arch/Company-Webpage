      ...
      <footer className="w-full border-t-8 border-orange-600 bg-zinc-50 dark:bg-zinc-900 flex flex-col md:flex-row justify-between items-start px-8 py-16 gap-10">
        <div className="flex flex-col items-start gap-6 max-w-sm">
          ...
          <div className="flex gap-4 mt-2">
            ...
            <a aria-label="Instagram" className="w-10 h-10 rounded-full bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:bg-orange-100 hover:text-orange-600 transition-colors" href="https://www.instagram.com/mohit_gas_service_" target="_blank" rel="noopener noreferrer">
            ...
            <a aria-label="WhatsApp" className="w-10 h-10 rounded-full bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:bg-orange-100 hover:text-orange-600 transition-colors" href="https://wa.me/918570972010" target="_blank" rel="noopener noreferrer">
